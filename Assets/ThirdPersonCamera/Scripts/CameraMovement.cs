...
namespace ThirdPersonCamera
{
    ...
    [RequireComponent(typeof(DebugInfo))]
    public class CameraMovement : MonoBehaviour
    {
        ...
        private Vector3 ClampCameraMinDistance(float distance)
        {
            ...
            if (followTargetToCam.magnitude < distance)
            {
        ...
        private Vector3 OrbitTarget(Vector3 orbitAngles, float deltaTime)
        {
            ...
            return ShortenFollowDistanceToAvoidRearOcclusion(followTarget.transform.position + (newOffset.normalized * newDistance)); //scale normalised offset by new distance and convert back to world position
        }
        ...
        private void UpdateConvenienceComponentVars()
        {
            ...
            camParams = components.GetCameraParams();
        }
        #endregion
    }
}